...
public class Md5 {
    ...
    public Md5 (InputStream in) {
        ...
        /** 
         * @Description:	通过key获取加密后的md5串
         * @param key
         * @return
         * @return	String
         * @author	liujq
         * @Date	2015年6月24日 下午1:36:56 
         */
         ...
         * @return	String
         * @author	liujq
         * @Date	2015年12月2日 下午6:44:18 
         */
        public static String getMd5StrUpperCase(String key){
        	Md5 md5=new Md5(key);
			md5.processString();
			return md5.getStringDigest().toUpperCase();
        }
        public static String getMd5Str(String key,String enc){
        	Md5 md5=new Md5(key,enc);
			md5.processString();
			return md5.getStringDigest();
        }
        ...
        public static void main(String[] args) throws NoSuchAlgorithmException {
        	...
        	System.out.println(getMd5Str("9001#9001"));
